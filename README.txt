1）The comunication between two clients requires two checks, which means after A indicates it is willing 
...
2）Assume the cient enter a right name at once. If client entered a worng name, her/she will not able to 
enter a name again.

<<Srini said it is ok to work like this.>>